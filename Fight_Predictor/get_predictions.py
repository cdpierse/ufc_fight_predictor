...
class GetPredictions:
    ...
    def create_fighter_df(self, fighter1, fighter2,weight_class):
        """
...
if __name__ == ('__main__'):
    ...
    for prediction, col_name in zip(results[0],predictor_cols):
        if 'f1' in col_name:
            print(f'{col_name} prediction for {fighter1_name} is {prediction}')
        else:
            print(f'{col_name} prediction for {fighter2_name} is {prediction}')
